...
The body starts after the closing delimiter. Do not repeat `title` or `subtitle`
as the first body heading or paragraph. This is the canonical format for both
human-authored files and files generated by agents. Exact leading repetitions
are removed defensively during preparation; non-matching headings and standfirsts
remain body content.
