...
| D006 | Confirm the exact draft create/update/fetch request bodies and returned IDs for the live Substack editor. | Track 08 implementation       | Track 08      | Track 08, 11, 12    | Open; local capture and comparison tools now available                              |
...
- Add a local draft endpoint capture fixture once D006 is resolved; `api draft compare` now supports local diffing.
