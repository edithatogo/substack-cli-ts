...
| D007 | Define the initial MCP surface for exposing CLI summaries and validation flows without leaking secrets.   | User request                  | Track 14      | Track 15            | Resolved: `mcp surface` manifest with redacted read/review tool groups              |
