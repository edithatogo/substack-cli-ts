...
| D006 | Confirm the exact draft create/update/fetch request bodies and returned IDs for the live Substack editor. | Track 08 implementation       | Track 08      | Track 08, 11, 12    | Open; local capture, comparison, fixture, contract inference, matrix, matrix-fixture, and matrix-compare tools now available |
