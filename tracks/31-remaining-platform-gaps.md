...
**Complete** — Gap catalogue completed for the currently discovered API surface. Future endpoint discovery or Substack platform changes should create a new follow-up track.
