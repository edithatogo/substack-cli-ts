...
- Configured GitHub-enforced strict branch protection after PR #176 proved native auto-merge could merge before non-required Mutation completed. The required-check set and solo-maintainer controls are captured in ranch-protection-receipt.md.
