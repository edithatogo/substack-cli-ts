...
- CI-RULESETS-009: Protect the default branch with a solo-maintainer-compatible ruleset requiring stable automated checks while blocking deletion and force pushes.
